...
public static class ExtensionMethod
{
	...
	//public static void SetButtonEvent(this UIEconomyButton button, ButtonRepeatEvent buttonEvent, UnityAction onClick = null , UnityAction onUp = null)
	//{
	//	button.SetEvent(buttonEvent, onClick, onUp);
	//}
	...
	//			return PlatformManager.Language["str_ui_status_info_atk_buff"];
	//		case StatsType.Hp_Buff:
	//			return PlatformManager.Language["str_ui_status_info_hp_buff"];
	//		case StatsType.Hp_Recovery_Buff:
	//			return PlatformManager.Language["str_ui_status_info_hp_recovery_buff"];
	...
	//			return PlatformManager.Language["str_ui_status_info_damage_reduce"];
	//		case StatsType.Def:
	//			return PlatformManager.Language["str_ui_status_info_def"];
	//		case StatsType.Def_Buff:
	//			return PlatformManager.Language["str_ui_status_info_def_buff"];
